...
- Render Free tier hosting (devops [ADR-016](https://github.com/alexandervivas/expat-ledger-devops/blob/main/docs/decisions/ADR-016-render-hosting.md); not in force), docs & blueprint.
