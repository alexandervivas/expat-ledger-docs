...
- OWASP ASVS 5.0.0 Level 2 verified target, with 13.3.4, 13.1.4 and the hardware-backed elevation of 13.3.1 adopted deliberately, 13.3.3 deferred on the P95 latency budget, and a recorded 13.2.1 deviation for static database credentials (see ADR-027)
